# Storyline: Download osint files amd create iptables ruleset
...
# Task: Replace the iptables syntax above with the cisco rulset syntax. sample: access-list 1 deny host 1.1.1.2
